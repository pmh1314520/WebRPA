...
<p align="center">
  <img src="https://img.shields.io/badge/版本-2.3.65-blue.svg" alt="版本">
...
项目内置 560+ 个功能模块与一位具备自愈能力的 AI 小助手：你可以用一句话描述需求，由 AI 自动搭建、排错并重跑工作流。所有运行环境（Python 3.13、Node.js、浏览器引擎、媒体与文档处理工具）均已随包内置，解压双击启动器即可使用，无需联网、无需额外安装，天然适配内网与局域网部署。
...
依托 560+ 个内置模块（按场景分门别类，拖入画布即可使用），WebRPA 覆盖以下关键能力：
