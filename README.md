...
<p align="center">
  <img src="https://img.shields.io/badge/版本-3.1.0-blue.svg" alt="版本">
  <img src="https://img.shields.io/badge/模块数量-569个-brightgreen.svg" alt="模块数量">
...
项目内置 569 个功能模块与一位具备自愈能力的 AI 小助手：你可以用一句话描述需求，由 AI 自动搭建、排错并重跑工作流。所有运行环境（Python 3.13、Node.js、浏览器引擎、媒体与文档处理工具）均已随包内置，解压双击启动器即可使用，无需联网、无需额外安装，天然适配内网与局域网部署。
...
- **模块丰富**：569 个功能模块，覆盖 95% 自动化场景（含基于 DrissionPage 的反检测网页自动化模块）
...
依托 569 个内置模块（按场景分门别类，拖入画布即可使用），WebRPA 覆盖以下关键能力：
