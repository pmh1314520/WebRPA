...
Object.assign(UI_DICT, {
  ...
  "手势录制失败或超时nn请确保：n1. 摄像头正常工作n2. 手部在摄像头视野内n3. 在30秒内按下空格键确认": "Gesture recording failed or timed out.nnPlease ensure:n1. The camera is working properlyn2. Your hand is within the camera's viewn3. Press the spacebar within 30 seconds to confirm",
  ...
  "模块工作流已成功保存！nn是否继续编辑？nn点击\"确定\"继续编辑，点击\"取消\"退出编辑模式。": "Module workflow saved successfully!nnContinue editing?nnClick \"OK\" to keep editing, or \"Cancel\" to exit edit mode.",
  "已退出自定义模块编辑模式": "Exited custom module edit mode",
  "确定要退出编辑模式吗？nn未保存的修改将会丢失。": "Are you sure you want to exit edit mode?nnUnsaved changes will be lost.",
