...
Object.assign(UI_DICT, {
  ...
  '🌐 自动化浏览器': '\ud83c\udf10 Automation Browser', '浏览器原理与元素选择器': 'Browser fundamentals and element selectors',
  ...
  '🗄️ 数据库操作': '\ud83d\uddc4\ufe0f Databases', 'MySQL/PostgreSQL/SQLite/Redis 等数据库': 'MySQL/PostgreSQL/SQLite/Redis and more',
  ...
  '👁️ AI识别与爬虫': '\ud83d\udc41\ufe0f AI Recognition & Crawling', 'OCR、验证码、人脸识别、AI智能爬虫': 'OCR, captcha, face recognition, AI smart crawler',
  '🖥️ 桌面应用自动化': '\ud83d\udda5\ufe0f Desktop Automation', 'Windows桌面程序控制、窗口管理、控件操作': 'Control Windows desktop apps, windows and controls',
  '🖱️ 屏幕鼠标键盘': '\ud83d\uddb1\ufe0f Screen, Mouse & Keyboard', '屏幕截图、真实鼠标键盘模拟、图像点击': 'Screenshots, real mouse/keyboard simulation, image clicks',
  '🖼️ 图像处理': '\ud83d\uddbc\ufe0f Image Processing', '图像编辑、格式转换、水印、二维码': 'Image editing, format conversion, watermarks, QR codes',
  ...
  '🚀 飞书自动化': '\ud83d\ude80 Feishu Automation', '飞书多维表格和电子表格自动化操作': 'Automate Feishu Bitable and spreadsheets',
  '🔗 网络与屏幕共享': '\ud83d\udd17 Network & Screen Sharing', '局域网文件共享、屏幕实时投屏': 'LAN file sharing and real-time screen casting',
  '🛠️ 实用工具': '\ud83d\udee0\ufe0f Utilities', '加密哈希、文件对比、颜色转换、打印': 'Hashing, file diff, color conversion, printing',
